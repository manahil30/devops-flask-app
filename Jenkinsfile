        ...
        stage('📊 Prometheus/Grafana Setup') {
            steps {
                ...
                sh """
                    ...
                    helm repo update
                    helm upgrade --install prometheus prometheus-community/kube-prometheus-stack --namespace monitoring --create-namespace --set grafana.service.type=NodePort --set grafana.service.nodePort=30001 --set prometheus.service.type=NodePort --set prometheus.service.nodePort=30002
